 ...
 * suffix. If a secondary address field (e.g. apartment, floor, suite, etc.) isn’t provided on the address form, the unit information can also be included at the end of address line 1.
 */
export type AddressStreetLine = string | {
	streetName: string
	streetNumber: number
	streetSuffix: string
}