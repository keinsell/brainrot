...
import {
	JwtPayload
}                                                          from "../value-objects/jwt-payload.js"
import {
	SignedJsonwebtoken
}                                                          from "../value-objects/signed-jsonwebtoken.js"
import {
	AccessToken
}                                                          from "../value-objects/tokens/access-token.js"
import {
	RefreshToken
}                                                          from "../value-objects/tokens/refresh-token.js"
import {
	TokenManagement
...
export class AuthenticationService {
	...
	public async authenticate(username: string,
		...
		const isValid = await this.credentialValidator.validateCredentials(username,
		                                                                   password
		)
