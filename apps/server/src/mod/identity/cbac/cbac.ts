...
export interface InitiatiatedCertificateChallenge
{
...
export interface CertificateBasedAuthenticationService
{
	...
	requestProofOfPossessionOfPrivateKey(request: InitiateCertificateBasedAuthentication): Promise<InitiatiatedCertificateChallenge>

	// 2. Server generates a challenge and sends it to the user
	generateAuthenticationChallenge(request: InitiatiatedCertificateChallenge): Promise<GetCertificateBasedAuthenticationChallenge>
...
export class CertificateBasedAuthenticationController
{
	...
	@Post('/initiate')
	async initiateCertificateBasedAuthentication(@Body() initiateCertificateBasedAuthenticationRequest: InitiateCertificateBasedAuthentication): Promise<InitiatiatedCertificateChallenge>
	{
		let account: any
