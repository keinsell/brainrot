...
import {createAssert, createIs, tags, TypeGuardError} from 'typia'
import type {Opaque, UnwrapOpaque}                    from '../../../kernel/libraries/opaque.js'
...
export class InvalidUsername extends BadRequestException {
	constructor() {
