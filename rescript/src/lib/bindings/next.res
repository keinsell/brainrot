...
// Add Request type for Next.js
module Request = {
  type t

  @get external cookies: t => Js.Dict.t<string> = "cookies"
  @get external headers: t => Js.Dict.t<string> = "headers"
  @get external nextUrl: t => {"pathname": string, "searchParams": Js.Dict.t<string>} = "nextUrl"
}
