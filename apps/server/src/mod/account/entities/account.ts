...
import {AggregateRootProperties, BaseAggregateRoot} from '../../../kernel/libraries/domain/aggregate.js'
...
export class Account extends BaseAggregateRoot<AccountId> implements IdentityProperties {
