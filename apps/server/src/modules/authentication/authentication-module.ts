...
import {
	DatabaseModule
}                       from "../../common/modules/storage/database/database.module.js"
import {
...
}                       from "./repositories/prisma-session-repository.js"
import {
	SessionRepository
...
}                       from "./services/authorization-strategies/jwt-authorization-strategy.js"
import {
	LocalAuthorizationStrategy
}                       from "./services/authorization-strategies/local-authorization-strategy.js"
import {
	JwtTokenManagement, TokenManagement
}                       from "./services/token-management.js"
